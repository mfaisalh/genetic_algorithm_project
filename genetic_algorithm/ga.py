...
class GeneticAlgorithm:
    ...
    def evolve(self):
        ...
        for gen in range(self.generations):
            ...
            logging.info(f"Generation {gen}: Best fitness = {record['min']}")
        ...
        logging.info("Evolution process completed")
...
def main():
    ...
    ga = GeneticAlgorithm(eval_func='rastrigin', elite_size=3)
    # ga.load_state("checkpoint_gen_40.pkl")  # Load state from checkpoint if needed
    pop, log, hof = ga.evolve()
    best_individual, best_fitness = ga.get_best_individual()
    
    print("Best individual:", best_individual)
    print("With fitness value:", best_fitness)
